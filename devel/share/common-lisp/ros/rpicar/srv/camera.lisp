...
(cl:defmethod cl:initialize-instance :after ((m <camera-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rpicar-srv:<camera-request> is deprecated: use rpicar-srv:camera-request instead.")))

(cl:ensure-generic-function 'camera_info-val :lambda-list '(m))
(cl:defmethod camera_info-val ((m <camera-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rpicar-srv:camera_info-val is deprecated.  Use rpicar-srv:camera_info instead.")
  (camera_info m))
...
(cl:defmethod cl:initialize-instance :after ((m <camera-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rpicar-srv:<camera-response> is deprecated: use rpicar-srv:camera-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <camera-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rpicar-srv:success-val is deprecated.  Use rpicar-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'status_message-val :lambda-list '(m))
(cl:defmethod status_message-val ((m <camera-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rpicar-srv:status_message-val is deprecated.  Use rpicar-srv:status_message instead.")
  (status_message m))
