...
echo_and_run cd "/home/pi/catkin_ws/src/battery_listener"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pi/catkin_ws/src/battery_listener/setup.py" \
     \
    build --build-base "/home/pi/catkin_ws/build/battery_listener" \
    install \
    --root="${DESTDIR-/}" \
